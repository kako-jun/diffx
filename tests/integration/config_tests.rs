...
"#,
    ...
    writeln!(
        file1,
        r#"{{"name": "Alice", "age": 30, "timestamp": "2024-01-01", "value": 1.0001}}"#
    )
    .unwrap();
    writeln!(
        file2,
        r#"{{"name": "Alice", "age": 31, "timestamp": "2024-01-02", "value": 1.0002}}"#
    )
    .unwrap();
...
"#,
    ...
    writeln!(
        file1,
        r#"{{"name": "Alice", "age": 30, "timestamp": "2024-01-01"}}"#
    )
    .unwrap();
    writeln!(
        file2,
        r#"{{"name": "Alice", "age": 31, "timestamp": "2024-01-02"}}"#
    )
    .unwrap();
...
"#,
    ...
    // Create test files
    fs::write(
        dir1.join("config.json"),
        r#"{"name": "service1", "timestamp": "2024-01-01"}"#,
    )
    .unwrap();
    fs::write(
        dir2.join("config.json"),
        r#"{"name": "service2", "timestamp": "2024-01-02"}"#,
    )
    .unwrap();
...
"#,
    ...
    writeln!(
        file1,
        r#"{{"name": "Alice", "age": 30, "timestamp": "2024-01-01", "debug": "info"}}"#
    )
    .unwrap();
    writeln!(
        file2,
        r#"{{"name": "Alice", "age": 31, "timestamp": "2024-01-02", "debug": "warn"}}"#
    )
    .unwrap();
...
"#,
    ...
    writeln!(
        file1,
        r#"{{"name": "Alice", "age": 30, "timestamp": "2024-01-01", "value": 1.0}}"#
    )
    .unwrap();
    writeln!(
        file2,
        r#"{{"name": "Alice", "age": 31, "timestamp": "2024-01-02", "value": 1.05}}"#
    )
    .unwrap();
