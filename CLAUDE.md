...
#### 🎯 ドキュメント・仕様整備
- [ ] **高速化機能の使用例追加** - `docs/user-guide/getting-started.md`
- [ ] **CLI オプション競合チェック** - `--optimize` と他オプションの関係
- [ ] **パフォーマンスガイド作成** - いつ高速モードを使うべきか
- [ ] **制限事項の明記** - 高速モードで使えない機能があるか

#### 🧪 テストケース追加
- [ ] **オプション競合テスト** - 同時使用不可パターンの検証
- [ ] **パフォーマンステスト** - 大容量データでのベンチマーク
- [ ] **エラーハンドリングテスト** - 不正な設定の適切な拒否
- [ ] **CLI統合テスト** - `--optimize` フラグの動作確認

#### 📚 ドキュメント更新箇所
1. **`docs/user-guide/getting-started.md`** - 高速モード使用例
2. **`docs/reference/cli-reference.md`** - `--optimize` オプション詳細
3. **`docs/guides/performance.md`** - パフォーマンス最適化ガイド
4. **`README.md`** - 簡潔な高速モード紹介
