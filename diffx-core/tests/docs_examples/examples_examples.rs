...
fn examples_example_2() {
    ...
    let _result =
        engine.diff_with_config("app_config_v1_content", "app_config_v2_content", &config);
}
...
fn examples_example_6() {
    ...
    let _result =
        engine.diff_with_config("deployment_v1_content", "deployment_v2_content", &config);
}
...
fn examples_example_9() {
    ...
    let _result = engine.diff_with_config(
        "helm_values_staging_content",
        "helm_values_production_content",
        &config,
    );
}
...
fn examples_example_10() {
    ...
    let _result = engine.diff_with_config(
        "ci_pipeline_old_content",
        "ci_pipeline_new_content",
        &config,
    );
}
...
fn examples_example_12() {
    ...
    config.output_format = "json".to_string();
    let _result = engine.diff_with_config(
        "expected_user_response_content",
...
fn examples_example_13() {
    ...
    let _result = engine.diff_with_config(
        "postman_collection_old_content",
        "postman_collection_new_content",
        &config,
    );
}
...
fn examples_example_14() {
    ...
    config.array_id_key = Some("name".to_string());
    let _result = engine.diff_with_config(
        "graphql_schema_v1_content",
        "graphql_schema_v2_content",
        &config,
    );
}
...
fn examples_example_15() {
    ...
    let _result = engine.diff_with_config(
        "soap_response_expected_content",
        "soap_response_actual_content",
        &config,
    );
}
...
fn examples_example_16() {
    ...
    config.output_format = "json".to_string();
    let _result = engine.diff_with_config(
        "input_data_sample_content",
        "output_data_sample_content",
        &config,
    );
}
...
fn examples_example_17() {
    ...
    let _result = engine.diff_with_config(
        "batch_job_input_content",
        "batch_job_output_content",
        &config,
    );
}
...
fn examples_example_19() {
    ...
    config.output_format = "json".to_string();
    let _result = engine.diff_with_config(
        "data_warehouse_snapshot_old_content",
...
fn examples_example_20() {
    ...
    let _result =
        engine.diff_with_config("ml_features_v1_content", "ml_features_v2_content", &config);
}
...
fn examples_example_21() {
    ...
    config.output_format = "unified".to_string();
    let _result = engine.diff_with_config(
        "db_schema_dump_old_content",
        "db_schema_dump_new_content",
        &config,
    );
}
...
fn examples_example_22() {
    ...
    let _result = engine.diff_with_config(
        "db_permissions_old_content",
        "db_permissions_new_content",
        &config,
    );
}
...
fn examples_example_23() {
    ...
    let _result =
        engine.diff_with_config("query_plan_old_content", "query_plan_new_content", &config);
}
...
fn examples_example_24() {
    ...
    let _result = engine.diff_with_config(
        "database_config_dev_content",
        "database_config_prod_content",
        &config,
    );
}
...
fn examples_example_25() {
    ...
    let _result = engine.diff_with_config(
        "prometheus_alerts_old_content",
        "prometheus_alerts_new_content",
        &config,
    );
}
...
fn examples_example_26() {
    ...
    let _result = engine.diff_with_config(
        "grafana_dashboard_v1_content",
        "grafana_dashboard_v2_content",
        &config,
    );
}
...
fn examples_example_27() {
    ...
    let _result = engine.diff_with_config(
        "cloudwatch_alarms_old_content",
        "cloudwatch_alarms_new_content",
        &config,
    );
}
...
fn examples_example_28() {
    ...
    config.output_format = "json".to_string();
    let _result = engine.diff_with_config(
        "elastic_mapping_old_content",
        "elastic_mapping_new_content",
        &config,
    );
}
...
fn examples_example_29() {
    ...
    config.show_unchanged = true;
    let _result = engine.diff_with_config(
        "logging_config_v1_content",
        "logging_config_v2_content",
        &config,
    );
}
...
fn examples_example_30() {
    ...
    config.output_format = "json".to_string();
    let _result =
        engine.diff_with_config("package_json_content", "package_lock_json_content", &config);
}
...
fn examples_example_31() {
    ...
    config.array_id_key = Some("name".to_string());
    let _result = engine.diff_with_config(
        "test_results_old_content",
        "test_results_new_content",
        &config,
    );
}
...
fn examples_example_32() {
    ...
    let _result = engine.diff_with_config(
        "code_metrics_before_content",
        "code_metrics_after_content",
        &config,
    );
}
...
fn examples_example_35() {
    ...
    config.output_format = "json".to_string();
    let _result = engine.diff_with_config(
        "security_policy_v1_content",
        "security_policy_v2_content",
        &config,
    );
}
...
fn examples_example_37() {
    ...
    let _result = engine.diff_with_config(
        "firewall_rules_old_content",
        "firewall_rules_new_content",
        &config,
    );
}
...
fn examples_example_38() {
    ...
    let _result = engine.diff_with_config(
        "compliance_report_q1_content",
        "compliance_report_q2_content",
        &config,
    );
}
...
fn examples_example_39() {
    ...
    config.show_unchanged = true;
    let _result = engine.diff_with_config(
        "audit_log_config_old_content",
        "audit_log_config_new_content",
        &config,
    );
}
...
fn examples_example_40() {
    ...
    config.output_format = "json".to_string();
    let _result = engine.diff_with_config(
        "performance_baseline_content",
        "performance_current_content",
        &config,
    );
}
...
fn examples_example_41() {
    ...
    let _result = engine.diff_with_config(
        "cache_config_old_content",
        "cache_config_new_content",
        &config,
    );
}
